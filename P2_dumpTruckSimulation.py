...
#   
#   Write a program to simulate the multi-channel dump truck system consisting of 6 trucks, 
#   2 loaders and 1 scale. Consider the standard initial assumptions. Calculate the server 
#   utilizations for a simulation period of 72 minutes
#
