...
#   
#   Write a program to show goodness of fit test using Kolmogorov Smirnov Test 
#   for the given population of random numbers. Assume significance value is equal to 0.05. 
#   Dcritical = 0.565
#
